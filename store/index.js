    ...
    products: [
        {
            ...
            description: `
Тісто на заквасці Lievito Madre, яке ферментується 3 дні<br><br>
✔️Високобілкове італійське борошно;<br>
✔️Фермерське вершкове масло;<br>
✔️Бельгійський шоколад (темний, молочний, карамельний);<br>
✔️Натуральна ваніль;<br>
✔️Боби тонка та м’якоть клементина.<br><br>
Святковий десерт преміум-класу.`,
            price: '1900',
            weight: '≈1 кг',
            iikoCode: '05900',
...
✔️Італійська марципанова паста;<br>
✔️Італійські апельсинові цукати;<br>
✔️Натуральне фермерське вершкове масло;<br>
✔️Сухофруктами та мигдаль;<br><br>
...
Для його приготування потрібно щонайменше 6 тижнів. За час дозрівання кекси стають кращими, ніжнішими, смачнішими. Їхня текстура перетворюється на щось маслянисте, а відкушуючи маленький шматочок, відчувається легке грайливе пощипування на язицi.`,
        ...
        },
        {
            id: 'P9',
            imgFile: 'karamel.jpg',
            title: 'Справжня солона карамель від Vanil',
            description: `Ніжна вершкова солона карамель, приготована на вершках 33%. Витончений смак для доповнення десертів або насолоди у чистому вигляді.`,
            price: '250',
            weight: '200 грамм',
            iikoCode: '05923',
...
✔️Справжній італійський панеттон від Vanil<br>
✔️Штоллен на натуральній заквасці Lievito Madre з марципаном<br>
✔️Англійський різдвяний кекс<br>
✔️Вершкова солона карамель`,
         price: '3400',
         weight: '',
         iikoCode: '07197',
         iikoId: '09485108-b66c-4a69-8354-c87f2e609b02'
     },
    {
        id: 'P7',
        imgFile: 'svechi.jpg',
