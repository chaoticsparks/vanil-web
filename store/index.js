...
Кремова, вишукана, з глибоким післясмаком.`,
      ...
      },
      {
        ...
        options: {
          name: 'Смак на вибір:',
          values: ['Nutella<br> Пухка здобна паска з ніжною текстурою та насиченим шоколадно-горіховим серцем Nutella.',
            'Cолона карамель<br> Пухка ванільна паска з кремовою начинкою солоної карамелі - баланс солодкого й легкої солоності.',
          `Лимонний курд<br> Легка здобна паска з яскравою начинкою лимонного курду - освіжаюча кислинка та ніжна кремовість.`],
